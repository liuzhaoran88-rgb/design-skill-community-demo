window.repoCommunitySkills = [
  {
    ...
    "metrics": {
      "usage_count": "10",
      "trace_records": "10 份 Wiki 追溯记录",
      "impact": "30-60 分钟沉淀 design.md"
    },
    "package": {
    ...
    "validation": {
      "status": "已在 16.0 设计规范建设中试用",
      "evidence": [
        "支持 Relay 节点解析、结构化 outline、design.md 写入",
        "用于把设计规范录入 Design Wiki 仓库"
      ]
    },
    "source": {
      "project": "16.0 设计系统升级",
    ...
    "cases": [
      {
        "title": "navbar-search-day 入库",
        "summary": "将 Relay 节点转成单份 design.md，并写入双向追溯索引。",
        "source": "Git commit f8a7fad · @ShuaiMXu",
        "result": "2026.05.13"
      },
      {
        "title": "channel-header-tabs 业务组件入库",
        "summary": "验证业务组件 page-doc bundle 的路径推断、字段校验和 Wiki 关联。",
        "source": "Git commit c3f69df · @ShuaiMXu",
        "result": "2026.05.14"
      }
    ],
    "relations": {
